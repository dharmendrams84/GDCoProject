...
function formSave()
{
    ...
    %>
    if(document.forms[0].employeeType.value=="0")
    document.forms[0].action='<%=request.getContextPath()+"/employee/addEmployee.do?action=save"%>';
    if(document.forms[0].employeeType.value=="1")
    document.forms[0].action='<%=request.getContextPath()+"/employee/addTempEmployee.do?action=save"%>';
    document.forms[0].submit();
}
function formBack()
{
...
<tr><td>&nbsp;</td><td>&nbsp;</td></tr>
    ...
    <tr>
    <td>
    <display:table class="tableWidth"  frame="HSIDES" cellspacing="1" name="currentEmployeeList" decorator="oracle.retail.stores.webmodules.employee.ui.EmployeeTableDecorator"
    requestURI='<%=request.getContextPath()+"/employee/addEmployee.do"%>'
    pagesize="5">
    ...
    <tr>
    <td>
    <display:table class="tableWidth"   frame="HSIDES" cellspacing="1" name="duplicateEmployeeList" decorator="oracle.retail.stores.webmodules.employee.ui.EmployeeTableDecorator"
    requestURI='<%=request.getContextPath()+"/employee/addEmployee.do"%>'
    pagesize="5">
    <display:caption class="tableHeader">
